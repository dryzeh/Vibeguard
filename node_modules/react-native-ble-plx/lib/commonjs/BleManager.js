...
class BleManager {
  ...
  constructor() {
    ...
    if (restoreStateFunction != null && options.restoreStateIdentifier != null) {
      ...
      this._activeSubscriptions[this._nextUniqueID()] = this._eventEmitter.addListener(_BleModule.BleModule.RestoreStateEvent, nativeRestoredState => {
        if (nativeRestoredState == null) {
          restoreStateFunction(null);
          return;
        }
        restoreStateFunction({
          connectedPeripherals: nativeRestoredState.connectedPeripherals.map(nativeDevice => new _Device.Device(nativeDevice, this))
        });
      });
    }
   ...
   */
  _destroyPromises() {
    const destroyedError = new _BleError.BleError({
  ...
  async _callPromise(promise) {
    ...
    try {
      ...
      delete this._activePromises[id];
      throw (0, _BleError.parseBleError)(error.message, this._errorCodesToMessagesMapping);
    }
  }
  ...
  async enable(transactionId) {
    ...
    await this._callPromise(_BleModule.BleModule.enable(transactionId));
    return this;
  }
  ...
  async disable(transactionId) {
    ...
    await this._callPromise(_BleModule.BleModule.disable(transactionId));
    return this;
  }
  ...
  onStateChange(listener) {
    ...
    const subscription = this._eventEmitter.addListener(_BleModule.BleModule.StateChangeEvent, listener);
    const id = this._nextUniqueID();
  ...
  startDeviceScan(UUIDs, options, listener) {
    ...
    const scanListener = _ref => {
      ...
      listener(error ? (0, _BleError.parseBleError)(error, this._errorCodesToMessagesMapping) : null, nativeDevice ? new _Device.Device(nativeDevice, this) : null);
    };
  ...
  async requestConnectionPriorityForDevice(deviceIdentifier, connectionPriority, transactionId) {
    ...
    const nativeDevice = await this._callPromise(_BleModule.BleModule.requestConnectionPriorityForDevice(deviceIdentifier, connectionPriority, transactionId));
    return new _Device.Device(nativeDevice, this);
  }
  ...
  async readRSSIForDevice(deviceIdentifier, transactionId) {
    ...
    const nativeDevice = await this._callPromise(_BleModule.BleModule.readRSSIForDevice(deviceIdentifier, transactionId));
    return new _Device.Device(nativeDevice, this);
  }
  ...
  async requestMTUForDevice(deviceIdentifier, mtu, transactionId) {
    ...
    const nativeDevice = await this._callPromise(_BleModule.BleModule.requestMTUForDevice(deviceIdentifier, mtu, transactionId));
    return new _Device.Device(nativeDevice, this);
  }
  ...
  async devices(deviceIdentifiers) {
    const nativeDevices = await this._callPromise(_BleModule.BleModule.devices(deviceIdentifiers));
  ...
  async connectedDevices(serviceUUIDs) {
    const nativeDevices = await this._callPromise(_BleModule.BleModule.connectedDevices(serviceUUIDs));
    return nativeDevices.map(nativeDevice => {
      return new _Device.Device(nativeDevice, this);
    });
  }
  ...
  async connectToDevice(deviceIdentifier, options) {
    const nativeDevice = await this._callPromise(_BleModule.BleModule.connectToDevice(deviceIdentifier, options));
    return new _Device.Device(nativeDevice, this);
  }
  ...
  async cancelDeviceConnection(deviceIdentifier) {
    const nativeDevice = await this._callPromise(_BleModule.BleModule.cancelDeviceConnection(deviceIdentifier));
    return new _Device.Device(nativeDevice, this);
  }
  ...
  onDeviceDisconnected(deviceIdentifier, listener) {
    const disconnectionListener = _ref2 => {
      ...
      listener(error ? (0, _BleError.parseBleError)(error, this._errorCodesToMessagesMapping) : null, new _Device.Device(nativeDevice, this));
    };
    const subscription = this._eventEmitter.addListener(_BleModule.BleModule.DisconnectionEvent, disconnectionListener);
    const id = this._nextUniqueID();
  ...
  async discoverAllServicesAndCharacteristicsForDevice(deviceIdentifier, transactionId) {
    ...
    const nativeDevice = await this._callPromise(_BleModule.BleModule.discoverAllServicesAndCharacteristicsForDevice(deviceIdentifier, transactionId));
    return new _Device.Device(nativeDevice, this);
  }
  ...
  async servicesForDevice(deviceIdentifier) {
    const services = await this._callPromise(_BleModule.BleModule.servicesForDevice(deviceIdentifier));
    return services.map(nativeService => {
      return new _Service.Service(nativeService, this);
    });
  }
  ...
  async _handleCharacteristics(characteristicsPromise) {
    ...
    return characteristics.map(nativeCharacteristic => {
      return new _Characteristic.Characteristic(nativeCharacteristic, this);
    });
  }
  ...
  async _handleDescriptors(descriptorsPromise) {
    ...
    return descriptors.map(nativeDescriptor => {
      return new _Descriptor.Descriptor(nativeDescriptor, this);
    });
  }
  ...
  async readCharacteristicForDevice(deviceIdentifier, serviceUUID, characteristicUUID, transactionId) {
    ...
    const nativeCharacteristic = await this._callPromise(_BleModule.BleModule.readCharacteristicForDevice(deviceIdentifier, serviceUUID, characteristicUUID, transactionId));
    return new _Characteristic.Characteristic(nativeCharacteristic, this);
  }
  ...
  async _readCharacteristicForService(serviceIdentifier, characteristicUUID, transactionId) {
    ...
    const nativeCharacteristic = await this._callPromise(_BleModule.BleModule.readCharacteristicForService(serviceIdentifier, characteristicUUID, transactionId));
    return new _Characteristic.Characteristic(nativeCharacteristic, this);
  }
  ...
  async _readCharacteristic(characteristicIdentifier, transactionId) {
    ...
    const nativeCharacteristic = await this._callPromise(_BleModule.BleModule.readCharacteristic(characteristicIdentifier, transactionId));
    return new _Characteristic.Characteristic(nativeCharacteristic, this);
  }
  ...
  async writeCharacteristicWithResponseForDevice(deviceIdentifier, serviceUUID, characteristicUUID, base64Value, transactionId) {
    ...
    const nativeCharacteristic = await this._callPromise(_BleModule.BleModule.writeCharacteristicForDevice(deviceIdentifier, serviceUUID, characteristicUUID, base64Value, true, transactionId));
    return new _Characteristic.Characteristic(nativeCharacteristic, this);
  }
  ...
  async _writeCharacteristicWithResponseForService(serviceIdentifier, characteristicUUID, base64Value, transactionId) {
    ...
    const nativeCharacteristic = await this._callPromise(_BleModule.BleModule.writeCharacteristicForService(serviceIdentifier, characteristicUUID, base64Value, true, transactionId));
    return new _Characteristic.Characteristic(nativeCharacteristic, this);
  }
  ...
  async _writeCharacteristicWithResponse(characteristicIdentifier, base64Value, transactionId) {
    ...
    const nativeCharacteristic = await this._callPromise(_BleModule.BleModule.writeCharacteristic(characteristicIdentifier, base64Value, true, transactionId));
    return new _Characteristic.Characteristic(nativeCharacteristic, this);
  }
  ...
  async writeCharacteristicWithoutResponseForDevice(deviceIdentifier, serviceUUID, characteristicUUID, base64Value, transactionId) {
    ...
    const nativeCharacteristic = await this._callPromise(_BleModule.BleModule.writeCharacteristicForDevice(deviceIdentifier, serviceUUID, characteristicUUID, base64Value, false, transactionId));
    return new _Characteristic.Characteristic(nativeCharacteristic, this);
  }
  ...
  async _writeCharacteristicWithoutResponseForService(serviceIdentifier, characteristicUUID, base64Value, transactionId) {
    ...
    const nativeCharacteristic = await this._callPromise(_BleModule.BleModule.writeCharacteristicForService(serviceIdentifier, characteristicUUID, base64Value, false, transactionId));
    return new _Characteristic.Characteristic(nativeCharacteristic, this);
  }
  ...
  async _writeCharacteristicWithoutResponse(characteristicIdentifier, base64Value, transactionId) {
    ...
    const nativeCharacteristic = await this._callPromise(_BleModule.BleModule.writeCharacteristic(characteristicIdentifier, base64Value, false, transactionId));
    return new _Characteristic.Characteristic(nativeCharacteristic, this);
  }
  ...
  _handleMonitorCharacteristic(monitorPromise, transactionId, listener) {
    const monitorListener = _ref3 => {
      ...
      if (error) {
        listener((0, _BleError.parseBleError)(error, this._errorCodesToMessagesMapping), null);
        return;
      }
      listener(null, new _Characteristic.Characteristic(characteristic, this));
    };
    const subscription = this._eventEmitter.addListener(_BleModule.BleModule.ReadEvent, monitorListener);
    const id = this._nextUniqueID();
    const wrappedSubscription = {
      remove: () => {
        if (this._activeSubscriptions[id] != null) {
  ...
  async readDescriptorForDevice(deviceIdentifier, serviceUUID, characteristicUUID, descriptorUUID, transactionId) {
    ...
    const nativeDescriptor = await this._callPromise(_BleModule.BleModule.readDescriptorForDevice(deviceIdentifier, serviceUUID, characteristicUUID, descriptorUUID, transactionId));
    return new _Descriptor.Descriptor(nativeDescriptor, this);
  }
  ...
  async _readDescriptorForService(serviceIdentifier, characteristicUUID, descriptorUUID, transactionId) {
    ...
    const nativeDescriptor = await this._callPromise(_BleModule.BleModule.readDescriptorForService(serviceIdentifier, characteristicUUID, descriptorUUID, transactionId));
    return new _Descriptor.Descriptor(nativeDescriptor, this);
  }
  ...
  async _readDescriptorForCharacteristic(characteristicIdentifier, descriptorUUID, transactionId) {
    ...
    const nativeDescriptor = await this._callPromise(_BleModule.BleModule.readDescriptorForCharacteristic(characteristicIdentifier, descriptorUUID, transactionId));
    return new _Descriptor.Descriptor(nativeDescriptor, this);
  }
  ...
  async _readDescriptor(descriptorIdentifier, transactionId) {
    ...
    const nativeDescriptor = await this._callPromise(_BleModule.BleModule.readDescriptor(descriptorIdentifier, transactionId));
    return new _Descriptor.Descriptor(nativeDescriptor, this);
  }
  ...
  async writeDescriptorForDevice(deviceIdentifier, serviceUUID, characteristicUUID, descriptorUUID, valueBase64, transactionId) {
    ...
    const nativeDescriptor = await this._callPromise(_BleModule.BleModule.writeDescriptorForDevice(deviceIdentifier, serviceUUID, characteristicUUID, descriptorUUID, valueBase64, transactionId));
    return new _Descriptor.Descriptor(nativeDescriptor, this);
  }
  ...
  async _writeDescriptorForService(serviceIdentifier, characteristicUUID, descriptorUUID, valueBase64, transactionId) {
    ...
    const nativeDescriptor = await this._callPromise(_BleModule.BleModule.writeDescriptorForService(serviceIdentifier, characteristicUUID, descriptorUUID, valueBase64, transactionId));
    return new _Descriptor.Descriptor(nativeDescriptor, this);
  }
  ...
  async _writeDescriptorForCharacteristic(characteristicIdentifier, descriptorUUID, valueBase64, transactionId) {
    ...
    const nativeDescriptor = await this._callPromise(_BleModule.BleModule.writeDescriptorForCharacteristic(characteristicIdentifier, descriptorUUID, valueBase64, transactionId));
    return new _Descriptor.Descriptor(nativeDescriptor, this);
  }
  ...
  async _writeDescriptor(descriptorIdentifier, valueBase64, transactionId) {
    ...
    const nativeDescriptor = await this._callPromise(_BleModule.BleModule.writeDescriptor(descriptorIdentifier, valueBase64, transactionId));
    return new _Descriptor.Descriptor(nativeDescriptor, this);
  }
}
